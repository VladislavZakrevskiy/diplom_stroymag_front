        ...
        <div className="space-y-16">
            ...
            <section className="relative overflow-hidden rounded-xl">
                ...
                <div className="relative aspect-[2.5/1] w-full">
                    <Image
                        src="/placeholder.svg?height=600&width=1500&text=Карьера+в+СтройМаркет"
            ...
            <section className="container mx-auto px-4">
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                    ...
                    <div className="relative aspect-square overflow-hidden rounded-xl md:aspect-auto">
                        <Image
                            src="/placeholder.svg?height=600&width=600&text=Наша+команда"
