      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link
              href="/products"
              className={`text-gray-600 hover:text-gray-800 ${pathname.startsWith("/products") ? "font-medium" : ""}`}
            >
              Каталог
            </Link>
            <Link
              href="/promotions"
              className={`text-gray-600 hover:text-gray-800 ${pathname.startsWith("/promotions") ? "font-medium" : ""}`}
            >
              Акции
            </Link>
            <Link
              href="/delivery"
              className={`text-gray-600 hover:text-gray-800 ${pathname.startsWith("/delivery") ? "font-medium" : ""}`}
            >
              Доставка
            </Link>
            <Link
              href="/contacts"
              className={`text-gray-600 hover:text-gray-800 ${pathname.startsWith("/contacts") ? "font-medium" : ""}`}
            >
              Контакты
            </Link>
          </nav>
