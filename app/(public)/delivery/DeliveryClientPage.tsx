        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="distance" className="mb-1 block font-medium">
                                Расстояние от Ростова: {distance} км
                            </label>
                            <input
                                id="distance"
                                type="range"
            ...
            <div className="mt-6 rounded-lg bg-blue-50 p-4 text-blue-800">
                <p className="flex items-start">
                    ...
                    <span>
                        При заказе на сумму от 30 000 ₽ доставка в пределах Ростова осуществляется бесплатно. Для
                        уточнения стоимости доставки крупногабаритных товаров обратитесь к менеджеру.
                    </span>
                </p>
            </div>
        </div>
            ...
            <section>
                ...
                <div className="rounded-lg bg-white p-6 shadow-md">
                    <p className="mb-4 text-lg">
                        Компания СтройМаркет предлагает различные варианты доставки строительных материалов по Ростову и
                        Ростовской области. Мы стремимся сделать процесс получения товаров максимально удобным и быстрым
                        для наших клиентов.
                    </p>
                </div>
            </section>
                ...
                <div className="space-y-4">
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-md">
                        ...
                        <p className="text-gray-700">
                            ...
                            на сумму от 30 000 ₽ доставка в пределах Ростова осуществляется бесплатно. Оплата доставки
